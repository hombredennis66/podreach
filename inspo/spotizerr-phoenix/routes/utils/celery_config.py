...
DEFAULT_MAIN_CONFIG = {
    ...
    "episodeRetryCircuitRepeats": 6,
    "episodeRetryCircuitSeconds": 90,
}
...
task_routes = {
    ...
    "routes.utils.celery_tasks.download_episode": {"queue": "downloads"},
}
...
task_annotations = {
    ...
    "routes.utils.celery_tasks.download_episode": {
        "rate_limit": f"{MAX_CONCURRENT_DL}/m",
    },
